...
LOG_EVAL_PERIOD = 500
MAX_TRAIN_ROWS = 800  # potential_improvement3: train on substantially more rows (or the full dataset) to capture additional fraud patterns.
...
def train(args: argparse.Namespace) -> None:
    ...
    # potential_improvement4: add leakage-safe feature engineering, scaling, and anomaly handling beyond the bare minimum preprocessing shown here.
    split_series = (
